...
def aquacrop_context_from_saved_row(row: dict) -> dict[str, Any]:
    ...
    return {
        ...
        "weekly_yield_comparison": extra.get("weekly_yield_comparison")
        or extra.get("weekly_yield_projection")
        or [],
        "forecast_mode_caveat": extra.get("forecast_mode_caveat"),
        "multi_year_mode": bool(extra.get("multi_year_mode")),
        "planting_date": extra.get("planting_date") or row.get("start_date") or "",
        "allowable_mad_pct": extra.get("allowable_mad_pct"),
        "application_efficiency_pct": extra.get("application_efficiency_pct"),
        "weather_rows": extra.get("weather_rows") or [],
        "management_rows": extra.get("management_rows") or [],
        "soil_field_capacity_pct": extra.get("soil_field_capacity_pct"),
        "has_season_data": bool(extra.get("weather_rows") or extra.get("management_rows")),
        "total_gross_irrigation_mm": extra.get("total_gross_irrigation_mm"),
        "total_effective_irrigation_mm": extra.get("total_effective_irrigation_mm"),
        "total_runoff_mm": extra.get("total_runoff_mm"),
        ...
        "results_table_daily": extra.get("results_table_daily") or [],
        "results_table_weekly": extra.get("results_table_weekly") or [],
        "is_saved_run": True,
        "saved_run": row,
        "sidebar_active": "history",
    }
